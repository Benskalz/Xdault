...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function>{
        ...
        "exampleCardIntro": MessageLookupByLibrary.simpleMessage(
            "歡迎來到 Kryptos。當您收到或發送 NANO 時，交易將顯示如下："),
        ...
        "logoutDetail": MessageLookupByLibrary.simpleMessage(
            "本動作會刪除您在本裝置裡頭的種子及所有和 Kryptos 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
        "logoutReassurance":
        ...
        "passwordNoLongerRequiredToOpenParagraph":
            MessageLookupByLibrary.simpleMessage("您日後啟動 Kryptos 時不用輸入密碼。"),
        "passwordWillBeRequiredToOpenParagraph":
            MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 Kryptos。"),
        ...
        "requireAPasswordToOpenHeader":
            MessageLookupByLibrary.simpleMessage("需要密碼才可開啟 Kryptos 嗎？"),
        ...
        "shareNatrium": MessageLookupByLibrary.simpleMessage("分享 Kryptos"),
        "shareNatriumText": MessageLookupByLibrary.simpleMessage(
            "請試試 Kryptos —— 針對行動裝置的 NANO 錢包！"),
        ...
        "unlockBiometrics":
            MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 Kryptos"),
        "unlockPin": MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 Kryptos"),
